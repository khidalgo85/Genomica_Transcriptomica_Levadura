...
subtitle: "Pasantía en Bioinformática - Genómica de Levaduras"
...
[Tutorial](https://github.com/khidalgo85/Unix)
---
...
[Tutorial](https://github.com/khidalgo85/Genomica_Transcriptomica_Levadura)
---
class: center, middle, inverse
...
.pull-left[**Abordaje 1**

* <font size=2>Estimación del tamaño del genoma: Jellyfish</font>
* <font size=2>Corrección de Errores: FMLRC</font>
...
* <font size=2>Polishing: Pilon</font>
* <font size=2>Evaluación de la calidad del polished assembly: Quast/BUSCO</font>
* <font size=2>Scalffolding: SSPACE</font>

**Abordaje 2**
* <font size=2>Corrección de Errores: FMLRC</font>
* <font size=2>Montaje del genoma: Canu</font>
* <font size=2>Montaje del Híbrida: Spades</font>
* <font size=2>Evaluación de la calidad del raw assembly: Quast/BUSCO</font>
* <font size=2>Alineamiento short reads/ raw assembly: BWA</font>
* <font size=2>Polishing: Pilon</font>
* <font size=2>Evaluación de la calidad del polished assembly: Quast/BUSCO</font>
...
* Análisis del trasncriptoma = transcritos = mRNA
...
* Control de calidad RNA-seq (**RNA-SeqC**, **RSeqQC**, **Qualimap2**)
* Ensamblaje del Transcriptoma (Cufflinks)
* Cuantificación de la expresión (featureCounts, **Cuffquant**, HTSeq-count, **Cufflinks**)
* Expresión diferencial (**DESeq2**, edgeR, **Cuffdiff**, Ballgown)
* Anotación: Blast2Go, KEGG, EGGNOG
...
* **RPKM:** Reads por millón de kilobases. Esta métrica primero cálcula un factor, llamado "per million", dividiendo el total de reads por un millón. Posteriormente, el conteo de cada en es dividido por este factor, lo cual normaliza los valores por la profucndidad de la seuenciación. Por último esos valores son divididos por el tamaño de cada gen en kilobases. **Solo para single-end**
...
* Alineamiento: TopHat2, SamTools
* Control de calidad RNA-seq: RNA-SeqC, RSeqQC, Qualimap2
* Ensamblaje: Cufflinks
* Cuantificación de la expresión: Cuffquant, Cufflinks
* Expresión diferencial **Cuffdiff**
* Anotación: Blast2Go, KEGG, EGGNOG
...
* Ahora tienen un montón de información para analizar y sacar provecho! 
* Aprendieron varias herramientas bioinformáticas

### Les agradezco la oportunidad, porque aprendí mucho desde la preparación del contenido que les queria presentar, durante la ejecución y ahora espero que continuemos trabajando y generando conocimiento. 
---
...
.center[<img src="imgs/grupo.png" width=80%>]
