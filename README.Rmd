...
A continuación los comandos para la instalacion *SequelTools* dentro do ambiente *PacBioTools*
...
Ahora usted tiene tres ambientes: `QualityControl`, `bioinfo` y `Assembly`. En el primero, ud tiene instaladas los programas FastQC y Trimmomatic, en el segundo herramientas útiles para gestión de archivos, y en el tercero los ensambladores Canu y Spades. 
