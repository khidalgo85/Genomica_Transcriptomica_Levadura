...
Crie um arquivo de texto dentro da pasta `09.GeneAnnotation/` chamado `headers.txt`, use o editor de texto nano. Dentro del archivo copie los siguientes titulos de las columnas de las tablas generadas en la anotación por blast 
...
> * Usar otras bases de datos (p.e. KEGG, InterPro, TIGRFAM, Pfam, UniProt)
