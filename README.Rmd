...
En el directorio `05.Assembly/01.Canu` fueron creados varios outputs, use el comando `ls` para listar los archivos en el directorio de salida.
...
busco -m genome -i ../../../05.Assemblies/01.Canu/canu.contigs.fasta -o busco -l saccharomycetes_odb10 -c 15
