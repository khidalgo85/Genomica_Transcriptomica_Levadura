...
Ahora usted tiene tres ambientes: `quality`, `bioinfo` , `masurca` y `assembly`. En el primero, ud tiene instaladas los programas FastQC y Trimmomatic, en el segundo herramientas útiles para gestión de archivos, y en el tercero los ensambladores Canu y Spades. 
